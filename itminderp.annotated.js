angular.module('itminderp', ['ui.router', 'satellizer', 'ngMaterial', 'ngMessages', 'textAngular'
  ...
  .config(["$stateProvider", "$urlRouterProvider", "$authProvider", "$mdThemingProvider", "$mdIconProvider", "API_URL", "$httpProvider", "$provide", function ($stateProvider, $urlRouterProvider, $authProvider, $mdThemingProvider, $mdIconProvider, API_URL, $httpProvider, $provide) {
...
UserController.$inject = ["$http", "$auth", "$state", "$rootScope"];
...
SubscriptionController.$inject = ["$http", "$state", "API_URL"];
...
JudgementController.$inject = ["$http", "API_URL"];
